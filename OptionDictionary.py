...
codec = [#[[25, 29, 34, 38], './TAppEncoderStatic -c %s -fr 60 -f 10000' % HM_cfg_Path, 'HM', '265', 'testmode', 'read'],
        [[29, 35, 42, 48], './x265 --fps 60', 'x265', '265', 'test265', 'rea', 'None'],
        [[22, 28, 34, 40], './SvtHevcEncApp', 'svt', '265', 'testmode', 'rea', 'baseline'],
        [[29, 35, 42, 48], './SvtHevcEncApp', 'svt', '265', 'test', 'rea', 'None'],
